...
symObsNull <- function(op, a, b, cnum, cden, nLeaves, stateSlots, fOut, zSlots, gOut, point, pIn, Nt) {
    .Call(`_dMod_symObsNull`, op, a, b, cnum, cden, nLeaves, stateSlots, fOut, zSlots, gOut, point, pIn, Nt)
}
