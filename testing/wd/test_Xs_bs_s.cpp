...
extern "C" SEXP solve_test_Xs_bs_s(SEXP timesSEXP, SEXP paramsSEXP, SEXP sens1iniSEXP, SEXP sens2iniSEXP, SEXP fixedSEXP, SEXP abstolSEXP, SEXP reltolSEXP, SEXP maxprogressSEXP, SEXP maxstepsSEXP, SEXP hiniSEXP, SEXP root_tolSEXP, SEXP maxrootSEXP, SEXP forcingTimesSEXP, SEXP forcingValuesSEXP) {
try {

  StepChecker checker(INTEGER(maxprogressSEXP)[0], INTEGER(maxstepsSEXP)[0]);

  ublas::vector<AD> x(1);
  ublas::vector<AD> full_params(4);
  ...
  fixed_events.emplace_back(FixedEvent<ublas::vector<AD>, AD>{
    full_params[3],  // time
    0,    // state_index
    [full_params, &F](const ublas::vector<AD>& x, const AD& t) -> AD {
      return full_params[2];
    },  // value_func
    EventMethod::Add,  // method
    [full_params, &F](const ublas::vector<AD>& x, const AD& t) -> ublas::vector<AD> {
      ublas::vector<AD> grad(1);
      grad[0] = 0.0;
      return grad;
    }  // dh_dx_func
  });
